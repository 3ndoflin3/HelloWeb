...
<%@include file ="../includes/Cabecera.jsp" %>
	...
	<a href ="https://datatables.net/">Documentacion oficial</a>
	
	<section>		
		<p>plugin de js para dar estilos y funcionalidad a las tablas de html</p>
		<p>Este plugin nos permite ordenar columnas, filtrar por textos, paginacion, RWD (responsive web design) y muchas cosas mas</p>
		<p>Para que funcione el plugin es necesario:</p>
		<ol>
			<li>Importar el CSS (head)</li>
